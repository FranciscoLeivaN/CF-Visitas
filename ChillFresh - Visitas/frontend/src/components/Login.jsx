    ...
    if (isUsuarioIdValid && isPasswordValid) {
      ...
      try {
        ...
        if (response.success) {
          ...
          // Importar la función que obtiene el usuario del token JWT
          ...
          // Actualizar el contexto de autenticación con los datos del token
          login(userData);
    ...
    <div className="flex items-center justify-center min-h-screen w-full bg-white full-page">
      <div className="w-full max-w-md p-6 sm:p-8 m-4 space-y-6 sm:space-y-8 bg-white rounded-lg shadow-lg">
        ...
        <form className="mt-6 sm:mt-8 space-y-4 sm:space-y-6" onSubmit={handleSubmit}>
          <div>
            {' '}
            <label htmlFor="usuarioId" className="block text-sm font-medium text-black">
              Correo Electrónico
            </label>
            <input
              id="usuarioId"
